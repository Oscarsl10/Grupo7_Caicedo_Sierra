...
def load_data():
    try:
        ...
        raise ConnectionError(
            f"No se pudo leer la tabla 'videojuegos_top': {e}"
        )
...
with tab1:
    ...
    with col2:
        ...
        st.metric("⭐ Rating Promedio", f"{rating_prom:.2f}")
    ...
    with col4:
        ...
        st.metric("🎯 Con Metacritic", int(count_meta))
...
with tab2:
    ...
    if df_hist.empty:
        ...
        fig1 = px.line(series_count, x="AñoMes", y="Cantidad", markers=True, title="Lanzamientos por Mes")
        fig2 = px.line(series_rating, x="AñoMes", y="RatingPromedio", markers=True, title="Rating Promedio por Mes")
...
if os.path.exists(log_path):
    ...
    st.markdown("---")
    st.subheader("Últimos Logs del ETL")
